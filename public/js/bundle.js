	...
	var MainLayout = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('footer', { className: 'primary-footer' })
			);
		}
	});
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"p",
					null,
					"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec consectetur elit sit amet velit pharetra, pharetra semper sapien fringilla. Nunc gravida laoreet justo, id hendrerit turpis bibendum in. Curabitur sagittis, nunc vel dictum auctor, neque nisl fermentum dui, et sodales ligula orci nec arcu. Donec at dictum purus. Integer non velit lorem. Nam sit amet bibendum leo. Donec vel feugiat turpis. In mattis ac augue quis rhoncus. Ut sed eleifend elit. Integer nibh tortor, luctus non pulvinar ac, consequat eget risus. Nam et tellus ut lorem venenatis porta. Sed scelerisque augue sit amet erat molestie, vel porta libero accumsan. Fusce sed pellentesque urna. Sed eu dolor quis tortor ornare rhoncus feugiat vitae dolor. Nam at risus elementum, suscipit diam eu, finibus ligula."
				),
				_react2.default.createElement(
					"p",
					null,
					"Duis pulvinar sapien vel enim mattis pellentesque. Cras pellentesque, eros nec rutrum blandit, augue lorem iaculis magna, ut pulvinar nibh metus vitae purus. Morbi tempus urna eget condimentum gravida. Proin vel iaculis sem, vel tempor augue. Quisque scelerisque lacus quis libero molestie, id elementum tortor posuere. Sed malesuada nec enim ac lacinia. Maecenas sit amet sem mauris. Fusce quis egestas ligula. Nulla in volutpat sem."
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WidgetProfile = _react2.default.createClass({
		displayName: "WidgetProfile",
